        ...
        <div className="gt_wrapper">
          ...
          <div className="gt_main_content_wrap">
            ...
            <section id="teamSection">
              <div className="container">
                <div className="gt_hdg_1" data-aos="zoom-in-down">
                  <h3>Meet Our Founders</h3>
                  <span><img src="./assets/images/hdg-01.png" alt="" /></span>
                </div>
                <div className="row">
                  <div className="col-md-6 col-sm-6 aboutTeam" data-aos="zoom-in-right">
                    <div className="card">
                  ...
                  <div className="col-md-6 col-sm-6 aboutTeam" data-aos="flip-left">
                    <div className="card">
                      <div className="card-body">
                        <div className="row">
                          <div className="col-md-4 text-center">
